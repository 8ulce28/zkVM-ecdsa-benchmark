...
the program from running out of memory. After experimenting with these two variables for the guest code verifying a signature, I decided to set `CHUNK_SIZE=524288 = 2^19`, `CHUNK_BATCH_SIZE=1`
as the table shows:
