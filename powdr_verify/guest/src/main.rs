...
fn main() {
    ...
    let msg_bytes: [u8; 32] = [127, 208, 178, 212, 164, 94, 120, 175, 39, 225, 46, 45, 227, 107, 13, 145, 174, 219,
    233,37, 221, 212, 183, 86, 115, 138, 76, 85, 204, 251, 36, 114];
    ...
    assert_eq!(verify_key.verify(&msg_bytes, &signature).is_ok(), true);
}
